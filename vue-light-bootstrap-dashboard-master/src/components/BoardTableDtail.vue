  ...
  <div>
    <card>
      <form>
        ...
        <div class="text-right" aline="right"> 작성날짜 : {{ notice.postdate }}</div>
        ...
        <div class="row" v-if="isAdmin()">
          ...
          <div class="col-md-1">
            <b-button variant="outline-info" @click="toggleFixMode">수정</b-button>
          </div>
          <div class="col-md-1">
...
export default {
  ...
  methods: {
    ...
    updateBoard() {
      this.$store.dispatch("boardSession/modifyBoard", notice);
    },
  },
};
</script>
